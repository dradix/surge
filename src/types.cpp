...
const char *SQSTR[65] = {"a1", "b1", "c1", "d1", "e1", "f1", "g1", "h1", "a2", "b2",  "c2",
...
// Returns number of set bits in the bitboard. Faster than pop_count(x) when the bitboard has few
// set bits
...
const int DEBRUIJN64[64] = {0,  47, 1,  56, 48, 27, 2,  60, 57, 49, 41, 37, 28, 16, 3,  61,
...
// Returns the index of the least significant bit in the bitboard, and removes the bit from the
// bitboard
...
// Returns the representation of the move type in algebraic chess notation. (capture) is used for
// debugging
