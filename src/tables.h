...
// Returns a bitboard containing all squares that a piece on a square can move to, in the given
// position
template <PieceType P> constexpr Bitboard attacks(Square s, Bitboard occ)
{
...
// Returns a bitboard containing all squares that a piece on a square can move to, in the given
// position Used when the piece type is not known at compile-time
...
template <Color C> constexpr Bitboard pawn_attacks(Bitboard p)
{
